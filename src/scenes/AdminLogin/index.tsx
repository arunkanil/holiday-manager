                    ...
                    <div className="login-border-box py-5">
                      ...
                      {/* <div style={{ marginTop: '50px' }}>
                        <small className="text-muted">
                          Popup blockers interfere with the operation of this application.Please disable your popup blocker. Please click the 'Login'
                          button to continue.
                        </small>
                      </div>
                      <Button
                        ...
                        style={{ color: 'white', marginTop: '50px', marginBottom: '50px', width: '165px' }}
                        type="primary"
                      >
